...
export function WhatsAppButton({ 
  ...
  return (
    <a
      ...
      className={`inline-flex items-center justify-center bg-green-500 hover:bg-green-600 text-white font-medium transition-colors duration-200 ${sizeClasses[size]} ${className}`}
    >
      <svg
...
/**
 * Floating WhatsApp Button (sticky on page)
 */
